...
export default function HomeScreen() {
  ...
  const [isUpdateActivityModalVisible, setIsUpdateActivityModalVisible] =
    useState(false);
      ...
      <SignedOut>
        ...
        >
          ...
          <Text
            style={[
              styles.subtitle,
              { color: colors.text, textAlign: "center", marginBottom: 32 },
            ]}
          >
            Your project management companion
          </Text>
          <View style={styles.authButtons}>
            <Link href="/sign-in" asChild>
              <TouchableOpacity
                style={[styles.authButton, { backgroundColor: colors.blue }]}
              >
